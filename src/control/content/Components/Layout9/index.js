  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="layOutContainer">
        ...
        <>
          <ThumbnailUI index={1} recommended={"Recommended: 675 x 940"} thumbnailImage={thumbnailImage} setThumbnailImage={setThumbnailImage} imageTag={"Background Image"} classList={"vertical-rectangle thumbnail"} />
        </>
        <div className="row">
        ...
        </div>
        {
          uploadType == "image" ?
            (
              <>
                <ThumbnailUI index={2} recommended={"Recommended: 1200 x 380"} thumbnailImage={thumbnailImage2} setThumbnailImage={setThumbnailImage2} imageTag={"Top Image"} classList={"thumbnail2 horizontal-rectangle"} />
              </>
            ) : (
              <>
        ...
        <>
          <ThumbnailUI index={3} recommended={"Recommended: 1200 x 675"} thumbnailImage={thumbnailImage3} setThumbnailImage={setThumbnailImage3} imageTag={"Main Image"} classList={"thumbnail3 horizontal-rectangle"} />
        </>
        <div className="row">
          <div className="col-md-3">
            <label className="lable">Enable Full Screen</label>
