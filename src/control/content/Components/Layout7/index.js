...
function index(props) {
  ...
  const setObjectData = (e) => {
    let checkBoxes;
    if (document.getElementById("enableFullScreen1").checked) {
      checkBoxes = true;
    } else {
      checkBoxes = false;
    }
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="layOutContainer">
        ...
        <div className="row">
          ...
          <div className="col-md-9">
            <input onChange={setObjectData} type="checkBox" name="enableFullScreen1" id="enableFullScreen1" />
          </div>
        </div>
        <div className="row">
          <div className="col-md-3">
        ...
        <div className="row">
          ...
          <div className="col-md-9">
            ...
            <label className="lable">Image</label>
            <input onChange={setObjectData} type="radio" name="mediaType2" value="video" />
            <label className="lable">Video</label>
          </div>
        </div>
        <div className="row">
